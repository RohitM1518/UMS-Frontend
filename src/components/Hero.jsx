...
const Hero = ({ toggleNewsletter }) => (
    <div className=' text-black'>
        <div className="relative text-black">
            ...
            <div className="absolute top-16 left-28 text-white p-6 md:p-12">
                <h1 className="text-4xl md:text-6xl font-bold hidden md:block text-black">Presidency University</h1>
                <h1 className="text-2xl md:text-4xl font-bold md:hidden text-black">Presidency University</h1>
